...
const LogOut=()=>{
  ...
  deleteCookie('mytoken')
    ...
    <div className="row">
  <div className="col-sm-3 border-right " style={{height:'90vh'}}>
    ...
    <div className="nav flex-column " id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <svg className="bi bi-lock mr-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg className="bi bi-at mr-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-bag mr-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <a className="nav-link " id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">
      <svg className="bi bi-list-task mr-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
       ...
       <button className="btn btn-link mt-5" onClick={LogOut} >
       <svg className="bi bi-box-arrow-right mr-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="col-sm-9 " style={{backgroundColor:'#83a6c7'}}>
    <div className="tab-content" id="v-pills-tabContent">
      ...
      <div className="tab-pane fade" id="v-pills-log" role="tabpanel" aria-labelledby="v-pills-log-tab">
